...
load newmeshfile.mat

headmesh.Vertices=newmesh.vertices;
headmesh.Faces=newmesh.faces;

figure
patch(headmesh,'FaceColor',       [0.8 0.8 1.0], ...
         'EdgeColor',       'none',        ...
...
[EEGPts1,EEGLab1] = ComputeEEGPos(Fiducials,headmesh.Faces,headmesh.Vertices,1,0);
[EEGPts2,EEGLab2] = ComputeEEGPos(Fiducials,headmesh.Faces,headmesh.Vertices,2,0);
[EEGPts3,EEGLab3] = ComputeEEGPos(Fiducials,headmesh.Faces,headmesh.Vertices,3,0);
