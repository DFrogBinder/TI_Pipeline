...
EXPORT_VARS="ALL,REPAIR_CLI=${REPAIR_CLI},ORIGINAL_ROOT=${ORIGINAL_ROOT:-},OUTPUT_ROOT=${OUTPUT_ROOT},MODE=${MODE},SCALED_ROOT=${SCALED_ROOT:-},PAIR2_RERUN_ROOT=${PAIR2_RERUN_ROOT:-},LOG_DIR=${LOG_DIR},MONTAGE_PRESET=${MONTAGE_PRESET},OVERWRITE_OUTPUT=${OVERWRITE_OUTPUT},INCLUDE_UNAFFECTED=${INCLUDE_UNAFFECTED},DATASET_GLOB=${DATASET_GLOB}"
