...
OUTPUT_ROOT="${OUTPUT_ROOT:-/mnt/parscratch/users/cop23bi/charm_segmentations_corrected_v3_no_blood}"
...
JOB_NAME="${JOB_NAME:-charm_seg_cleanup_v3_no_blood}"
COLLECTOR_JOB_NAME="${COLLECTOR_JOB_NAME:-collect_charm_seg_cleanup_v3_no_blood}"
