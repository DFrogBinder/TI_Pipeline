...
EXPORTS="ALL,TI_CHARM_CLEANUP_MANIFEST=${MANIFEST},TI_CHARM_CLEANUP_WORKFLOW_PY=${WORKFLOW_PY},TI_CHARM_CLEANUP_LOG_DIR=${LOG_DIR},TI_CHARM_CLEANUP_MAX_RETRIES=${MAX_RETRIES},TI_CHARM_CLEANUP_CSF_RADIUS=${CSF_RADIUS},TI_CHARM_CLEANUP_SKIN_RADIUS=${SKIN_RADIUS},TI_CHARM_CLEANUP_COMPONENT_POLICY=${COMPONENT_POLICY},TI_CHARM_CLEANUP_WM_MIN_COMPONENT_VOXELS=${WM_MIN_COMPONENT_VOXELS},TI_CHARM_CLEANUP_GM_MIN_COMPONENT_VOXELS=${GM_MIN_COMPONENT_VOXELS},TI_CHARM_CLEANUP_CONNECTIVITY=${CONNECTIVITY}"
...
COLLECT_SUBMISSION=$("${SBATCH_BIN}" \
    --parsable \
    --job-name="collect_charm_seg_cleanup_v1" \
    --partition="${PARTITION}" \
