...
def main_function(settings_file, stl_models_path, electrode_attributes_path,save_dir):
    ...
    for folder in folders:
        ...
        meshing.load_surface_meshes(os.path.join(stl_models_path, folder), ['skin_fixed.stl', 'skull_fixed.stl', 'csf_fixed.stl', 'gm_fixed.stl', 'wm_fixed.stl', 'cerebellum_fixed.stl', 'ventricles_fixed.stl'])
